...
Future<GingaConfig> resolveGingaConfig({
  ...
  if (!kIsWeb) {
    final appFile =
        (appSrc != null && !isHttpUri(appSrc)) ? File(appSrc).absolute : null;
    final configFile = (configSrc != null && !isHttpUri(configSrc))
  ...
  if (!kIsWeb && initialAppSrc != null && !isHttpUri(initialAppSrc)) {
    try {
