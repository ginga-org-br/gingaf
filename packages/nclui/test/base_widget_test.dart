...
import 'package:nclui/nclui.dart';

void main() {
  testWidgets('WidgetFactory creates ImageWidget for image mime types',
      (tester) async {
    final media = Media(
      rawAttributes: {'id': 'img1', 'src': 'test.png'},
      mimeType: 'image/png',
    );
    final widget = WidgetFactory.createMediaWidget(media: media);
    expect(widget, isNotNull);
    expect(widget, isA<ImageWidget>());
  });

  testWidgets('WidgetFactory creates AVWidget for video mime types',
      (tester) async {
    final media = Media(
  ...
  testWidgets('WidgetFactory creates LuaWidget for lua mime types',
      (tester) async {
    final media = Media(
  ...
  testWidgets('WidgetFactory creates TextWidget for text/plain mime types',
      (tester) async {
    final media = Media(
