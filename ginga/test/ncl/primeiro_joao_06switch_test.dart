  ...
  <body>
    ...
    <context id="ctxAdvert">
      ...
      <switch id="form">
        ...
        <media id="ptForm" src="ptForm.html" descriptor="dForm"/>
        <media id="enForm" src="enForm.html" descriptor="dForm"/>
      </switch>
...
void main() {
  ...
  testWidgets('NCLApp updates Switch layout in response to language rule',
    ...
    expect(mainVideoWidget.left, moreOrLessEquals(0.0));
    expect(mainVideoWidget.top, moreOrLessEquals(0.0));
    expect(mainVideoWidget.width, moreOrLessEquals(800.0));
    expect(mainVideoWidget.height, moreOrLessEquals(600.0));
  });
}
